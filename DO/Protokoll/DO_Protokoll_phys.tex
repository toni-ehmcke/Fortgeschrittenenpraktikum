...
\section{Messprinzip: Ionisationskammer}
...
\begin{equation}
	D = \int \limits_{t_1}^{t_2} \dot{D}(t)\ \mathrm{d}t \approx \frac{w \cdot \Delta t}{e \cdot \rho \cdot V} \cdot I
\end{equation}
