...
Bevor wir die eigentlich Messdaten aufnehmen könnten, musste die Messapperatur kalibriert werden:
    \subsubsection{Messung einer Quelle bekannter Aktivität bei mittiger Quellposition} \label{dft:kalib_mitte}
       ...
       \begin{gather}
           ...
           \label{dff:NG}
       \end{gather}
       Dabei ist in \ref{dff:NG} $\dot N$ gegeben durch die Gesamtzahl der Ereignisse $N=400000$ (vorgegeben) geteilt durch die Zeit $\tilde t_{A/B}$, die bis zum Erreichen dieser Zahl benötigt wurde. 
    ...
    ergibt sich $l = \unit[(46,5\pm4,3)]{cm}$ Dieser Wert ist größer als der, der uns in der Aufgabenstellung verraten wurde und weicht um 20\% ab. Dies liegt daran, 
